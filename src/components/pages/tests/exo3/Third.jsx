...
export default function Third() {
    ...
    function mouli() {
        const result = ["png", "torrent", "txt", false, "htaccess"];
        const params = ["blatherskite.png", "perfectlylegal.torrent", "spaces are fine in file names.txt", "this does not have one", ".htaccess"];
    ...
    return (
        <div className='third'>
            ...
            <div className="thirdBottom">
                {go === 5 ?
                    <button className="submitButton" onClick={() => {alert("Congrats to you, you have done all exercises")}}>CONGRATS</button>
                :
...
function Editor(props) {
    ...
    React.useEffect(() => {
        onChange(`function getFileExtension(i) {\n\t// i will be a string, but it may not have a file extension.\n\t// return the file extension (with no period) if it has one, otherwise false\n\n}`);
