...
export default function Second() {
    ...
    function mouli() {
        const result = [true, false, true, true, true];
        const params = [2, 3, 0, -2, Math.floor(Math.random()*1000000)*2];
    ...
    return (
        <div className='second'>
            ...
            <div className="secondBottom">
                {go === 5 ?
                    <Link to="/exo3" style={{textDecoration: "none"}}>
...
function Editor(props) {
    ...
    React.useEffect(() => {
        onChange(`function isNumberEven(i) {\n\t// i will be an integer. Return true if it's even, and false if it isn't.\n\n}`);
